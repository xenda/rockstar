...
==Tracks
    ...
    # Love a song, session_key is returned by Scrobbler::Auth. See Scrobbler::TokenAuth or
...
More details can be found in in Scrobbler::TokenAuth
...
http://rdoc.info/projects/bitboxer/scrobbler
